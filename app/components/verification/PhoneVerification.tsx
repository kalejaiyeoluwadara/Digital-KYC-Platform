      ...
      <CardHeader>
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <CardDescription>Verify your phone number and SIM age (+15 points)</CardDescription>
          </div>
        </div>
      </CardHeader>
              ...
              <div className="flex gap-2 items-start">
                ...
                <div className="text-sm text-blue-900">
                  ...
                  <p className="mt-1 text-blue-700">
                    SIM cards active for 6+ months add credibility to your profile.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="p-6 bg-green-50 rounded-lg border border-green-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h4 className="font-semibold text-green-900">SIM Verified!</h4>
                  <p className="text-sm text-green-700">Your SIM card has been validated</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                <div className="p-3 bg-white rounded-lg">
                  ...
                  <p className="text-lg font-bold text-gray-900">{simAge} months</p>
                </div>
                <div className="p-3 bg-white rounded-lg">
