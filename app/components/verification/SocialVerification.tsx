...
import { Link2, CheckCircle2, Linkedin, X } from "lucide-react";
...
export const SocialVerification: React.FC<SocialVerificationProps> = ({
  ...
  const handleConnect = async (platform: "google" | "linkedin" | "twitter") => {
    ...
    const points = platform === "linkedin" ? 10 : 5;
    const platformName =
      platform === "twitter"
        ? "X"
        : platform.charAt(0).toUpperCase() + platform.slice(1);
    toast.success(`${platformName} connected! +${points} points`);
  };
  ...
  const totalPoints =
    (connectedProfiles.google ? 5 : 0) +
    (connectedProfiles.linkedin ? 10 : 0) +
    (connectedProfiles.twitter ? 5 : 0);
      ...
      <CardHeader>
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <CardDescription>
              Connect social accounts to boost your trust score (up to +20
              points)
            </CardDescription>
          </div>
        </div>
            ...
            <div className="flex gap-2 items-start">
              ...
              <div className="text-sm text-blue-900">
                ...
                <p className="mt-1 text-blue-700">
                  Verified work/school domain emails and established social
                  profiles add significant credibility to your digital identity.
                </p>
              </div>
            </div>
          </div>
